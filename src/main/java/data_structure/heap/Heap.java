...
public class Heap {
        ...
        while (index <= upto) {
            ...
            if (leftChild <= upto) {
                ...
                if (rightChild > upto) {
                    ...
                    childToSwap =
                        (heapData[leftChild] > heapData[rightChild]) ? leftChild : rightChild;
                }
    ...
    /**
     * Heap Sort could be called in a heap array, so we assume that this heap was built up by
     * calling insert repeatedly, and then we call heapSort on it.
     */
